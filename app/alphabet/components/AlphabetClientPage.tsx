...
export default function AlphabetClientPage({ lightweightLessons }: { lightweightLessons: any[] }) {
  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] font-sans text-slate-800 pb-28 md:pb-0">
      ...
      {/* Header */}
      {/* Mobile Top Header */}
      <header className={`bg-[#FAFAFA]/95 backdrop-blur-sm z-50 h-[3.75rem] md:hidden sticky top-0 transition-transform duration-300 ${showHeader && !selectedLesson ? 'translate-y-0' : '-translate-y-full'}`}>
