      ...
      <div className="flex flex-col gap-3 relative z-10 mt-1">
        {questsForCategory.length === 0 ? (
          ...
          questsForCategory.map((quest, i) => {
            ...
            return (
              <div key={quest.id} className="group relative w-full flex flex-col bg-white rounded-2xl p-4 border-2 border-slate-100 shadow-[0_2px_10px_rgba(0,0,0,0.02)] hover:border-slate-200 transition-all overflow-hidden">
