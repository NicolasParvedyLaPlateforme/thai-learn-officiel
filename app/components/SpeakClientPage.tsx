...
const DesktopSidebarRight = dynamic(() => import('../components/DesktopSidebarRight').then(mod => mod.DesktopSidebarRight), { 
  ssr: false,
  loading: () => (
...
const SpeakQuestsModal = dynamic(() => import('./speak/SpeakQuestsModal'), { ssr: false });
const SpeakLockedReviewModal = dynamic(() => import('./speak/SpeakLockedReviewModal'), { ssr: false });
