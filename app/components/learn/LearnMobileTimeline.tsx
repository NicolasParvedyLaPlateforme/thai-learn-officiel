    ...
    <main className="max-w-2xl mx-auto px-4 mt-2 flex flex-col gap-8 md:hidden">
      ...
      >
        ...
        <div className="flex flex-col relative w-full mt-8 pb-20 pl-2 pr-2 sm:pl-4 sm:pr-4">
          {/* Vertical progress line shifted to the left */}
          ...
          {nextUnit && (
            ...
            >
              <div className="relative shrink-0 z-10 group-hover:scale-105 group-active:scale-95 transition-all">
                <div className={`w-10 h-10 sm:w-12 sm:h-12 rounded-full flex items-center justify-center border-[4px] border-[#FAFAFA] relative z-10 shadow-sm overflow-hidden ${nextUnit.colorClass} text-white`}>
