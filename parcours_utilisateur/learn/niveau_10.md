# Parcours Utilisateur : Niveau 10 d'une Leçon (Section /learn)

Ce document décrit étape par étape le parcours complet d'un utilisateur lorsqu'il effectue le Niveau 10 d'une leçon dans la section Apprentissage (`/learn`).

## 1. Déclenchement de la leçon (La Timeline)
- **Où se trouve l'utilisateur ?** Sur la page d'accueil de la section `/learn`.
- **Ce qu'il voit :** L'utilisateur voit le nœud de la leçon, qui affiche déjà un avancement partiel (9/10).
...
- **Action :** L'utilisateur clique sur **"Continuer"**. L'application le redirige vers l'URL de la leçon correspondante (`/lesson/ID_DE_LA_LECON?level=10`).
...
- **Types d'exercices et Objectifs (Spécificité du Niveau 10) :**
  - C'est l'examen final (Maîtrise). L'utilisateur doit compléter une longue série d'exercices d'écriture libre (Free Typing) sans droit à l'erreur (ou très peu). Il doit prouver sa maîtrise parfaite du vocabulaire et des phrases.
...
- **Ce qu'il voit (Écran de Complétion) :**
  ...
  - Un message célébrant la fin du niveau 10.
  - **Gain d'XP :** Le chiffre **+300 XP** s'affiche en grand (la récompense standard de l'application pour avoir complété le Niveau 10 pour la toute première fois de la journée).
...
- **Ce qu'il voit :**
  ...
  - **Progression Visuelle :** La bordure est maintenant 100% remplie (10/10). Un badge **"Maîtrisé"** ou une **Couronne** apparaît sur le nœud. Le bouton principal change d'état et affiche désormais **"Réviser"**.
