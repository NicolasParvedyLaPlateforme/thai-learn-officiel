...
## Emplacement 1
**Fichier :** `NicolasParvedyLaPlateforme-thai-learn-officiel-bfe663e/src/components/learn/LearnLockedReviewModal.tsx`
**Lignes :** 11 - 49

```tsx
export default function LearnLockedReviewModal({ isOpen, onClose, language }: LearnLockedReviewModalProps) {
  return (
    <AnimatePresence>
      {isOpen && (
        <motion.div
...
## Emplacement 2
**Fichier :** `NicolasParvedyLaPlateforme-thai-learn-officiel-bfe663e/src/components/speak/SpeakLockedReviewModal.tsx`
**Lignes :** 11 - 49
