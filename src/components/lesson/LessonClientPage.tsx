              ...
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <motion.div
                    ...
                    className={`${state.showInstruction || state.showHelpModal || state.currentExercise?.type === "pair-matching" || state.currentExercise?.type === "sound-to-letter" || state.currentExercise?.type === "true-false" || state.currentExercise?.type === "missing-letter" || state.currentExercise?.type === "one-letter-difference" ? "hidden" : "flex"} flex-1 md:flex-none w-full max-w-3xl overflow-y-auto md:overflow-y-visible px-4 py-4 md:py-4 flex-col ${state.isKeyboardOpen ? "justify-end pb-[5vh] md:justify-center md:pb-4" : "justify-center"} hide-scrollbar`}
                  >
                    {state.currentExercise?.type !== "pair-matching" && state.currentExercise?.type !== "sound-to-letter" && state.currentExercise?.type !== "true-false" && state.currentExercise?.type !== "missing-letter" && state.currentExercise?.type !== "one-letter-difference" && (
                      <QuestionArea
                        currentExercise={state.currentExercise as Exercise}
                        lesson={lesson}
                        language={state.language}
                  ...
                  <motion.div
                    ...
                    className={`${state.showInstruction || state.showHelpModal ? "hidden" : "flex"} ${state.currentExercise?.type === "pair-matching" || state.currentExercise?.type === "sound-to-letter" || state.currentExercise?.type === "true-false" || state.currentExercise?.type === "missing-letter" || state.currentExercise?.type === "one-letter-difference" ? "flex-1 items-center" : "shrink-0 md:shrink-0"} bg-transparent px-4 pb-4 pt-2 md:pt-4 md:pb-8 justify-center z-10 w-full max-w-3xl`}
                  >
                    <div className={cn("w-full relative", (state.currentExercise?.type === "true-false" || state.currentExercise?.type === "sound-to-letter" || state.currentExercise?.type === "missing-letter" || state.currentExercise?.type === "one-letter-difference") && "h-full")}>
                      <ErrorBoundary>
