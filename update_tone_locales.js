...
const translations = {
  fr: {
    ...
    "composition.implicit_a_vowel": "Voyelle implicite : Cette consonne forme une syllabe ouverte, on prononce un 'A' court (ะ) invisible.",
    "composition.implicit_o_vowel": "Voyelle implicite : Lorsqu'il n'y a pas de voyelle écrite entre une consonne initiale et finale, on prononce un 'O' court (โ-ะ) invisible.",
  ...
  en: {
    ...
    "composition.implicit_a_vowel": "Implicit Vowel: This consonant forms an open syllable, a short, invisible 'A' (ะ) is pronounced.",
    "composition.implicit_o_vowel": "Implicit Vowel: When there is no written vowel between an initial and final consonant, a short, invisible 'O' (โ-ะ) is pronounced.",
  ...
  es: {
    ...
    "composition.implicit_a_vowel": "Vocal implícita: Esta consonante forma una sílaba abierta, se pronuncia una 'A' corta (ะ) invisible.",
    "composition.implicit_o_vowel": "Vocal implícita: Cuando no hay una vocal escrita entre una consonante inicial y final, se pronuncia una 'O' corta (โ-ะ) invisible.",
  ...
  de: {
    ...
    "composition.implicit_a_vowel": "Impliziter Vokal: Dieser Konsonant bildet eine offene Silbe, ein kurzes, unsichtbares 'A' (ะ) wird gesprochen.",
    "composition.implicit_o_vowel": "Impliziter Vokal: Wenn kein Vokal zwischen einem Anfangs- und Schlusskonsonanten geschrieben steht, wird ein kurzes, unsichtbares 'O' (โ-ะ) gesprochen.",
  ...
  it: {
    ...
    "composition.implicit_a_vowel": "Vocale implicita: Questa consonante forma una sillaba aperta, si pronuncia una 'A' corta (ะ) invisibile.",
    "composition.implicit_o_vowel": "Vocale implicita: Quando non c'è una vocale scritta tra una consonante iniziale e finale, si pronuncia una 'O' corta (โ-ะ) invisibile.",
